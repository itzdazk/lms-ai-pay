...
async function main() {
  ...
  const course = await prisma.course.upsert({
    ...
    create: {
      ...
      description: 'Learn web development from beginner to advanced level. Build real-world projects.',
      shortDescription: 'Master web development with HTML, CSS, JavaScript, React, Node.js and more',
      price: 999000,
      ...
      whatYouLearn: 'HTML, CSS, JavaScript, React, Node.js, MongoDB, Git, Deployment',
      courseObjectives: 'Build 10+ real projects, Get job-ready skills, Learn industry best practices',
      targetAudience: 'Beginners who want to become web developers, Students, Career changers',
      status: 'PUBLISHED',
      isFeatured: true,
      ratingAvg: 4.8,
      ratingCount: 250,
