...
class QuizzesController {
    ...
    getQuizById = asyncHandler(async (req, res) => {
        ...
        const quiz = await studentQuizzesService.getQuizById(quizId, userId, userRole);
    ...
    getLessonQuizzes = asyncHandler(async (req, res) => {
        ...
        const quizzes = await studentQuizzesService.getLessonQuizzes(lessonId, userId, userRole);
    ...
    getCourseQuizzes = asyncHandler(async (req, res) => {
        ...
        const quizzes = await studentQuizzesService.getCourseQuizzes(courseId, userId, userRole);
