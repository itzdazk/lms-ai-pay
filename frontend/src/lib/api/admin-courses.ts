...
export interface PlatformAnalytics {
  ...
  topPerformers: {
    ...
    coursesByRevenue: Array<AdminCourse & { totalRevenue: number; totalOrders: number }>;
    instructors: Array<{
      id: number;
      userName: string;
      fullName: string;
...
export const adminCoursesApi = {
   ...
   */
  async getAllCourses(filters: AdminCourseFilters = {}): Promise<PaginatedResponse<AdminCourse>> {
   ...
   */
  async toggleCourseFeatured(courseId: number, isFeatured: boolean): Promise<AdminCourse> {
