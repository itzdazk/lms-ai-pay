...
function getGatewayBadge(gateway: PaymentTransaction['paymentGateway']) {
    return (
        <Badge
            variant='outline'
            className='border-[#2D2D2D] text-gray-300 text-xs flex items-center gap-1.5'
        >
                ...
                <DarkOutlineTableBody>
                    {transactions.map((transaction) => (
                        <DarkOutlineTableRow
                            ...
                            className={
                                onTransactionClick
                                    ? 'cursor-pointer hover:bg-[#1F1F1F] transition-colors'
                                    : ''
                            }
                            onClick={() => onTransactionClick?.(transaction)}
                        >
                            <DarkOutlineTableCell className='font-mono text-sm text-gray-400'>
                                #{transaction.id}
                            </DarkOutlineTableCell>
                            <DarkOutlineTableCell className='font-mono text-sm text-white'>
