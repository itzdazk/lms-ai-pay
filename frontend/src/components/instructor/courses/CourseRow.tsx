            ...
            >
                <DarkOutlineTableCell className='min-w-[250px] max-w-[400px]'>
                    <div className='flex items-start gap-3'>
                        ...
                        <div className='min-w-0 flex-1'>
                            <p className='font-medium text-white dark:text-white break-words whitespace-normal'>
                                {course.title}
                            </p>
                ...
                <DarkOutlineTableCell>
                    <div className='flex items-center gap-1'>
                        <Users className='h-4 w-4 text-gray-400 dark:text-gray-400' />
                ...
                <DarkOutlineTableCell className='text-right'>
                    <button
                        className='p-2 text-white hover:text-white hover:bg-[#1F1F1F] rounded'
                        onClick={(e) => {
                            e.stopPropagation()
