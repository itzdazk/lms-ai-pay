...
export function AboutPage() {
    ...
    const stats = !isLoadingConfig
        ? aboutConfig?.stats
            ? [
                  {
                      label: 'Khóa học',
                      value: aboutConfig.stats.courses,
                      icon: BookOpen,
                      color: 'text-blue-600',
                  },
                  {
                      label: 'Học viên',
                      value: aboutConfig.stats.students,
                      icon: Users,
                      color: 'text-green-600',
                  },
                  {
                      label: 'Giảng viên',
                      value: aboutConfig.stats.instructors,
                      icon: Award,
                      color: 'text-purple-600',
                  },
                  {
                      label: 'Chứng chỉ',
                      value: aboutConfig.stats.certificates,
                      icon: Award,
                            ...
                            >
                                <CardContent className='pt-6 pb-6'>
                                    <div className='flex justify-center mb-4'>
                                        <div
                                            className={`p-3 rounded-full bg-blue-600/10 ${stat.color}`}
                                        >
                                        ...
                                        <div key={index} className='flex gap-6'>
                                            <div className='flex flex-col items-center'>
                                                ...
                                                {index < array.length - 1 && (
                                                    <div className='w-0.5 h-full bg-[#2D2D2D] mt-2' />
                                                )}
                                            </div>
                                            <div className='pb-8'>
                                                <Badge className='mb-2 bg-[#1A1A1A] border border-[#2D2D2D] text-white'>
                                                    {milestone.year}
                                                </Badge>
            ...
            <section className='py-16 bg-background border-t border-gray-200 text-foreground'>
                <div className='container mx-auto px-4 text-center'>
                    ...
                    <p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto'>
                        Tham gia cùng hàng chục nghìn học viên đang phát triển
                        kỹ năng mỗi ngày
                    </p>
