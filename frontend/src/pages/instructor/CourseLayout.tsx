...
import { CourseFormProvider, useCourseForm } from '../../contexts/CourseFormContext';
...
function CourseLayoutContent() {
  ...
  const { hasChanges, setShowCancelDialog, showCancelDialog } = useCourseForm();
  ...
  const courseSteps = useMemo(() => [
    ...
    { id: 'quizzes', title: 'Câu hỏi ôn tập', description: 'Câu hỏi ôn tập theo bài học' },
  ], []);
    ...
    <div className="py-2 px-6 max-w-6xl mx-auto space-y-6">
      ...
      <Dialog open={showCancelDialog} onOpenChange={(open) => {
        ...
        <DialogContent className="bg-[#1F1F1F] border-[#2D2D2D] text-white">
          <DialogHeader>
            <DialogTitle className="text-white">Xác nhận rời khỏi</DialogTitle>
