...
export function CoursesPage() {
    ...
    useEffect(() => {
        if (
            ...
            (filters.status !== undefined ||
                ...
                filters.minEnrollments !== undefined ||
                filters.maxEnrollments !== undefined ||
    ...
    const loadInstructors = async () => {
        try {
            ...
            const instructors = await adminCoursesApi.getInstructorsForCourses(
                1000
            )
    ...
    const handleFilterChange = useCallback(
        (key: keyof AdminCourseFilters, value: any) => {
    ...
    const confirmToggleFeatured = async () => {
        ...
        try {
            ...
            toast.success(
                newFeaturedStatus
                    ? 'Đã đánh dấu nổi bật khóa học'
                    : 'Đã bỏ đánh dấu nổi bật khóa học'
            )
            setIsFeaturedDialogOpen(false)
            setSelectedCourse(null)
            ...
            <div className='w-full'>
                <div className='mb-6'>
                    ...
                    <p className='text-sm text-muted-foreground mt-1'>
                        Quản lý và theo dõi tất cả khóa học trên nền tảng
                    </p>
                </div>
